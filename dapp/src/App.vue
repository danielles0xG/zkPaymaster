...
const GREETER_CONTRACT_ADDRESS = "0x327260FF71083d2Fc0390f6Bd1BAe053a8148e1a"; 
// eslint-disable-next-line
  ...
  methods: {
    ...
    async getOverrides() {
      if (this.selectedToken.l1Address != ETH_L1_ADDRESS) {
          ...
          console.log("testnetPaymaster",testnetPaymaster);
    ...
    connectMetamask() {
      window.ethereum
        ...
        .then(() => {
          if (window.ethereum.networkVersion == 280){//280) {
            this.loadMainScreen();
          } else {
